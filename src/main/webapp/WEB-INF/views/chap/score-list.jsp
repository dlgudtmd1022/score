...
<div class="container">
    ...
    <form action="/score/register" method="POST">
        ...
        <input type="number" class="form-control" id="user-kor" name="korScore">
        <label for="user-math" class="form-label">수학성적</label>
        <input type="number" class="form-control" id="user-math" name="mathScore">
        <label for="user-eng" class="form-label">영어성적</label>
        <input type="number" class="form-control" id="user-eng" name="engScore">
